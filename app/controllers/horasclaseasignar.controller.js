...
const Horasclaseasignar = db.horasclaseasignar;
...
exports.getAdmin = async(req, res) => {
    ...
    if (req.body.solocabeceras == 1) {
        query = "SELECT * FROM s_horasclaseasignar_mgr('&modo=10&id_usuario=:id_usuario')"; //el modo no existe, solo es para obtener un registro
        ...
        query = "SELECT * FROM s_horasclaseasignar_mgr('" +
    ...
    Horasclaseasignar.findOne({
        ...
        .then(horasclaseasignar => {
            ...
            if (!horasclaseasignar) {
                ...
                horasclaseasignar.update(req.body.dataPack).then((self) => {
                    // here self is your instance, but updated
                    res.status(200).send({ message: "success", id: self.id });
                });
            }
