...
exports.getAdmin = async(req, res) => {
    ...
    if (req.body.solocabeceras == 1) {
        query = "SELECT * FROM s_horas_mgr('&modo=10&id_usuario=:id_usuario')"; //el modo no existe, solo es para obtener un registro
...
exports.getRecord = async(req, res) => {
    ...
    Horas.findOne({
        ...
        .then(horas => {
            if (!horas) {
                return res.status(404).send({ message: "Horas Not found." });
            }
