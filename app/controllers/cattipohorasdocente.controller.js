...
exports.getAdmin = async(req, res) => {
    ...
    if (req.body.solocabeceras == 1) {
        query = "SELECT * FROM s_cattipohorasdocente_mgr('&modo=10&id_usuario=:id_usuario')"; //el modo no existe, solo es para obtener un registro
...
exports.getCatalogoSegunMateria = async(req, res) => {
    ...
    res.status(200).send(datos[0].fn_tipohoradocentes_get);
}
