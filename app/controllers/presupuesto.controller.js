...
exports.getAdmin = async(req, res) => {
    ...
    if (req.body.solocabeceras == 1) {
        query = "SELECT * FROM s_presupuesto_mgr('&modo=10&id_usuario=:id_usuario')"; //el modo no existe, solo es para obtener un registro
        ...
        query = "SELECT * FROM s_presupuesto_mgr('" +
...
exports.getRecord = async(req, res) => {
    ...
    Presupuesto.findOne({
        ...
        .then(presupuesto => {
            if (!presupuesto) {
                return res.status(404).send({ message: "Presupuesto Not found." });
            }
