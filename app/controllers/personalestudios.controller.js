...
exports.getAdmin = async(req, res) => {
    ...
    if (req.body.solocabeceras == 1) {
        query = "SELECT * FROM s_personalestudios_mgr('&modo=10&id_usuario=:id_usuario')"; //el modo no existe, solo es para obtener un registro
...
exports.getAdminSub = async(req, res) => {
    ...
    if (req.body.solocabeceras == 1) {
        ...
        query = "SELECT * FROM s_personalestudiossub_mgr('&modo=10&id_usuario=:id_usuario')"; //el modo no existe, solo es para obtener un registro
...
exports.getRecord = async(req, res) => {
    ...
    Personalestudios.findOne({
        ...
        .then(personalestudios => {
            if (!personalestudios) {
                return res.status(404).send({ message: "personalestudios Not found." });
            }

            res.status(200).send(personalestudios);
        })
        .catch(err => {
            res.status(500).send({ message: err.message });
        });
