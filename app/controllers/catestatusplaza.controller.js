...
exports.getAdmin = async(req, res) => {
    ...
    if (req.body.solocabeceras == 1) {
        query = "SELECT * FROM s_catestatusplaza_mgr('&modo=10&id_usuario=:id_usuario')"; //el modo no existe, solo es para obtener un registro
...
exports.getCatalogo = async(req, res) => {
    ...
    Catestatusplaza.findAll({
            attributes: ['id', 'descripcion', 'convigencia', 'conlicencia', 'esinterina', 'esnombramiento', 'contitular',[db.sequelize.literal("descripcion || ' - ' || tipoocupplaza"), "text"],'tipoocupplaza'],
            where: {
                [Op.and]: [{
                        /*id: {
                            [Op.notIn]: [1, 2, 7, 8]
